      ...
      <div class="upcoming-announcements">
        <div class="upcoming">
          ...
          <ul class="upcoming-list">
            ...
            <li v-if="formattedEndDate !== 'Invalid Date'">Current billing period until: {{formattedEndDate}}
...
<script lang="ts" src="./AccountPage.ts">
  import ImportSkinsModal from "@/components/UserDashboard/ImportSkinsModal.vue";
  import SubscriptionModal from "@/components/AccountPage/SubscriptionModal.vue";
